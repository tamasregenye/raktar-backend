...
INSERT INTO `felhasznalok`(`email`, `jelszo`, `nev`) VALUES ('talannincsilyen@gmail.com','123456789','iuztiu');
...
INSERT INTO `felhasznalok`(`email`, `jelszo`, `szerepkor`, `nev`, `letrehozva`) VALUES ('admin@company.com','admin123','admin','Super Admin', CURRENT_TIMESTAMP());
...
INSERT INTO `termekek`(`kategoria_id`, `nev`, `egysegar`, `keszlet_db`) VALUES (17,'Csavarhúzó', 1500, 100);

/* 9. Módosítsd a "Akkus Csavarhúzó" nevű termék egységárát 2000 Ft-ra. Ha nincs ilyen termék, akkor előbb hozd létre. */
INSERT INTO `termekek`(`kategoria_id`, `nev`, `egysegar`, `keszlet_db`) VALUES (1, 'Akkus Csavarhúzó', 1400, 56);
...
SELECT `nev`, `email` FROM `felhasznalok` WHERE `szerepkor`='admin';

/* 11. Módosítsd az admin szerepkörű felhasználók utolsó bejelentkezésének dátumát a jelenlegi időre. */
UPDATE `felhasznalok` SET `legutobbi_bejelentkezes`=CURRENT_TIMESTAMP() WHERE `szerepkor`='admin';
...
SELECT * FROM `termekek` ORDER BY `egysegar`;
